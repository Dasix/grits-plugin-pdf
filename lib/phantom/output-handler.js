/**
 * This is the main Phantom.js wrapper class.  It tells Phantom.js to load a page
 * and then captures the output and returns it in various forms.
 *
 * Notes:
 * - Originally from: https://github.com/marcbachmann/node-html-pdf/blob/master/lib/pdf.js
 ...
 *
 * _When no #pageContent is available, phantomjs will use document.body as the input page content_
 */
	...
	child.on( "exit", function( code ) {
		...
		if( code || stderrCache.length ) {
			...
			try {
				...
				var er2 = new Error( "Phantom Data Parsing Failed: " + err.message );
