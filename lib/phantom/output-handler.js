...
prto._handleReturnData = function( obj ) {

	var me = this;

	if( obj.resources !== undefined && obj.resources.err !== undefined ) {
		me._warnAboutResources( obj.resources.err );
	}


};

prto._warnAboutResources = function( resourceArr ) {
	...
	_.each( resourceArr, function( resource ) {

		me.log("Warning! [" + resource.errorCode + "] " + resource.url );
...
prto._preParseHtml = function( html ) {
	...
	/*
	console.log(" ");
	console.log("---- preparse html ----");
	console.log(" ");

	console.log( opts );

	console.log(" ");
	console.log("---- end preparse html ----");
	console.log(" ");
	*/
...
prto._translateUrls = function( html ) {
