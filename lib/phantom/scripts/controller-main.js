...
var mParser	  = require( "./lib/content-parser.js" );
...
// Create the contentParser
var contentParser = new mParser( page, options, logger );

// Create the resourceManager
var resourceManager = new mResource( options, logger, contentParser );
...
function __createSection ( section, content, options ) {
	...
	function phantomCallback( pageNum, numPages ) {
		...
		ret = contentParser.replaceClassWithStyle(ret);
